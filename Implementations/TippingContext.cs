    ...
    public class TippingContext : ITippingContext
    {
            ...
            foreach (var item in LeaguePastResults[leagueCode])
            {
                ...
                foreach (var g in games)
                {
                    if (g.HomeScore > maxScore)
                        maxScore = g.HomeScore.Value;
                    if (g.AwayScore > maxScore)
                        maxScore = g.AwayScore.Value;
                }
            }
            return maxScore;
        }
            ...
            foreach (var item in LeaguePastResults[leagueCode])
            {
                ...
                foreach (var g in games)
                {
                    if (g.HomeScore < minScore)
                        minScore = g.HomeScore.Value;
                    if (g.AwayScore < minScore)
                        minScore = g.AwayScore.Value;
                }
            }
            return minScore;
        }
            ...
            string leagueCode)
        {
            ...
            foreach (var item in LeaguePastResults[leagueCode])
            {
                ...
                foreach (var g in games)
                {
                    totalHomePoints += g.HomeScore.Value;
                    totalAwayPoints += g.AwayScore.Value;
                    totalGames++;
                }
            }
            ...
            string leagueCode)
        {
            ...
            foreach (var item in LeaguePastResults[leagueCode])
            {
                ...
                foreach (var g in games)
                {
                    totalScore += g.AwayScore.Value + g.HomeScore.Value;
                }
            ...
            string leagueCode)
        {
            ...
            foreach (var item in LeaguePastResults[leagueCode])
            {
                ...
                foreach (var g in games)
                {
                    totalScore += Math.Abs(g.AwayScore.Value - g.HomeScore.Value);
                }
                totalGames += games.Count;
            }
            ...
            string teamCode)
        {
            ...
            foreach (var item in LeaguePastResults[leagueCode])
            {
                ...
                foreach (var g in games)
                {
                    ...
                    {
                        totalScore += g.HomeScore.Value;
                        totalGames++;
                    }
                    if (g.AwayTeam.Equals(teamCode))
                    {
                        totalScore += g.AwayScore.Value;
                        totalGames++;
                    }
                }
            }
            ...
            string leagueCode)
        {
            ...
            foreach (var item in LeaguePastResults[leagueCode])
            {
                ...
                foreach (var g in games)
                {
                    ...
                    totalScore += g.HomeScore.Value;
                    totalScore += g.AwayScore.Value;
                    AddScore(scoreDict, g.HomeScore.Value);
                    AddScore(scoreDict, g.AwayScore.Value);
                }
            }
            ...
            bool explain = false)
        {
            ...
            var eventStore = new TeamEventStore(DropBoxFolder);
