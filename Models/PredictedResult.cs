...
namespace TipItService.Models
{
    public class PredictedResult
    {
        ...
        public string Tip()
        {
            return $@"{GamePredictionOut(Game)} : Tip is {TipOut()} {MarginOut()}  {Schedina()}";
        }
        ...
        {
            return $@"{Game.GameDate.ToString("yyyy-MM-dd HH:mm")} {StringUtils.StringOfSize(4, game.AwayTeam)} {StringUtils.PadLeft(3, AwayScore.ToString())} @ {StringUtils.StringOfSize(4, game.HomeTeam)} {StringUtils.PadLeft(3, HomeScore.ToString())}";
        }
